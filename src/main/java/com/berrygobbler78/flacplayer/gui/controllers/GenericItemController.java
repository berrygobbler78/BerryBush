...
public class GenericItemController {
    ...
    public void setItemData(Artist artist) {
        ...
        itemImage.setImage(
                ImageUtils.pathToImage(artist.artPath())
                        .orElse(ImageUtils.pathToImage(artist.albums().getFirst().artPath())
                                .orElse(new Image(ImageUtils.getWarningURL()))));
    ...
    public void setItemData(Album album) {
        ...
        itemImage.setImage(ImageUtils.pathToImage(album.artPath()).orElse(new Image(ImageUtils.getWarningURL())));
        itemImage.setFitHeight(200);
        itemImage.setFitWidth(200);
    }
    ...
    public void setItemData(Song song) {
        ...
        itemImage.setImage(ImageUtils.pathToImage(song.album().artPath()).orElse(new Image(ImageUtils.getWarningURL())));
        itemImage.setFitHeight(200);
        itemImage.setFitWidth(200);
    }
}
